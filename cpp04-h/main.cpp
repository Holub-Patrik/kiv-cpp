 ...
 *    vsechny prumerne hodnoty v ramci balicku hodnot
 *
 *    2) Get_Min_Chunk_Average, Get_Max_Chunk_Average - implementujte tela
 *    metod - tyhle vrati nejnizsi, resp. nejvyssi z prumeru predpocitanych vyse
 *
 *    3) Get_Piecewise_Averages - implementujte telo metody - tahle spocte
 *    prumery ze vsech 1. mereni, 2. mereni, ... tj. prumer ze vsech prvnich
 *    cisel z balicku, druhych, ...
 *
 *    4) implementujte vlastni vyjimku, kterou budete vyhazovat, pokud nekdo
 *    zavola Get_Min_Chunk_Average nebo Get_Max_Chunk_Average drive, nez
